...
Do not roll AI workers back while either versioned report queue contains work. Stop producers and drain both queues and publication deliveries before rollback. The editorial downgrade refuses to remove the delivery gate while review-governed unpublished reports or review-enabled schedules remain. Publish or remove those reports and explicitly disable schedule review first; take a backup before removing editorial history.
