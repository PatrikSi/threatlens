...
_CONTROL_PLANE_OPERATIONS: tuple[OperationLiteral, ...] = (
    ...
    ('GET', '/v1/operations/health-history', 'health_history'),
    ('GET', '/v1/operations/lifecycle', 'get_lifecycle_overview'),
    ('POST', '/v1/operations/lifecycle/preview', 'post_lifecycle_preview'),
    ('PUT', '/v1/operations/lifecycle/policies/{target_key}', 'put_lifecycle_policy'),
    ('GET', '/v1/operations/lifecycle/runs', 'get_lifecycle_runs'),
    ('POST', '/v1/operations/lifecycle/runs', 'post_lifecycle_run'),
    ('GET', '/v1/operations/lifecycle/runs/{run_id}', 'get_lifecycle_run_detail'),
    ('POST', '/v1/operations/lifecycle/runs/{run_id}/cancel', 'post_lifecycle_run_cancel'),
    ('GET', '/v1/operations/overview', 'overview'),
    ('GET', '/v1/operations/runs', 'runs'),
    ('GET', '/v1/operations/workers', 'workers'),
...
_REQUEST_CONTEXT_OPERATIONS: tuple[OperationLiteral, ...] = (
    ...
    ('POST', '/v1/investigations/{investigation_id}/evidence-candidates', 'post_investigation_evidence_candidates'),
...
_ENDPOINT_NAMES_BY_MODULE: Final[dict[str, tuple[str, ...]]] = {
    ...
    "app.api.routes.investigations": (
        ...
        "post_investigation_evidence_candidates",
    ...
    "app.api.routes.lifecycle": (
        "get_lifecycle_overview",
        "get_lifecycle_run_detail",
        "get_lifecycle_runs",
        "post_lifecycle_preview",
        "post_lifecycle_run",
        "post_lifecycle_run_cancel",
