...
class AISettings(Base):
    ...
    report_context_window_tokens: Mapped[int] = mapped_column(Integer, nullable=False, default=8192, server_default="8192")
    report_reserved_output_tokens: Mapped[int] = mapped_column(Integer, nullable=False, default=1200, server_default="1200")
    report_source_token_cap: Mapped[int] = mapped_column(Integer, nullable=False, default=700, server_default="700")
    report_max_sources: Mapped[int] = mapped_column(Integer, nullable=False, default=100, server_default="100")
    report_max_model_calls: Mapped[int] = mapped_column(Integer, nullable=False, default=20, server_default="20")
    report_context_safety_percent: Mapped[int] = mapped_column(Integer, nullable=False, default=15, server_default="15")
