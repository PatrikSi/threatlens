...
export function StatsPage() {
  ...
  const statsQuery = useQuery({
    ...
    queryFn: () => apiFetch<StatsOverviewResponse>(`/stats/overview?days=${days}`),
  })
            ...
            <section className="rounded-xl border border-slate/20 bg-white/80 p-4 dark:border-cyan-900/40 dark:bg-[#040913]/90">
              ...
              <div className="mt-3 max-h-80 overflow-auto space-y-2">
                {statsQuery.data.daily_volume.map((point) => (
                  <div key={point.date} className="flex items-center justify-between rounded border border-slate/15 px-3 py-2 text-sm dark:border-cyan-950/40">
            ...
            <section className="rounded-xl border border-slate/20 bg-white/80 p-4 dark:border-cyan-900/40 dark:bg-[#040913]/90">
              ...
              <div className="mt-3 max-h-80 overflow-auto space-y-2">
                {statsQuery.data.top_domains.map((domain) => (
                  <div key={domain.domain} className="flex items-center justify-between rounded border border-slate/15 px-3 py-2 text-sm dark:border-cyan-950/40">
